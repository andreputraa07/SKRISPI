...
<head>
    ...
    <title>@yield('title') | SIDAEK</title>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="/dashboard" class="brand-link">
                ...
                <span class="brand-text font-weight-light">SIDAEK</span>
            </a>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; 2025 <a href="https://www.instagram.com/andreputraa07/">Skripsi Andre</a>.</strong> All rights
            reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
